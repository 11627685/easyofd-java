...
public class SongRotateTest {
    ...
    public void Test() throws IOException, FontFormatException {
        ...
        float afl=ascent+leading+descent;

        float af2=metrics.getHeight();
        String text2 = "宋";
        /*设置默认字体*/
        page.addText(text2,20.0,20.0,15);
        float top=(20- Util.pointsToMM(ascent));
        float width= Util.pointsToMM(metrics.stringWidth(text2));
        float height= Util.pointsToMM(metrics.getHeight());
        float  midline=top+height/2;
...
//        page.addLine(20,top ,20,top+height);
        ...
        try {
            ...
            os = new FileOutputStream("OfdFiles/text/宋旋转.ofd");
